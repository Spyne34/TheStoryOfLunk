...
#include "SkillSphereCollisionDetection.generated.h"

UCLASS()
class LUNK_API ASkillSphereCollisionDetection : public AActor
{
	GENERATED_BODY()
	
public:
	// Sets default values for this actor's properties
	ASkillSphereCollisionDetection();

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite)
	class USphereComponent* SphereDetectionMesh;
